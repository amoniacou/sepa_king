...
describe SEPA::CreditorIdentifierValidator do
  ...
  it 'should accept valid creditor_identifier' do
    expect(Validatable).to accept('DE98ZZZ09999999999', 'AT12ZZZ00000000001', 'FR12ZZZ123456', 'NL97ZZZ123456780001', for: %i[creditor_identifier crid])
  end

  it 'should not accept an invalid creditor_identifier' do
    expect(Validatable).not_to accept('', 'xxx', 'DE98ZZZ099999999990', for: %i[creditor_identifier crid])
  end
...
describe SEPA::MandateIdentifierValidator do
  ...
  it 'should not accept an invalid mandate_identifier' do
    expect(Validatable).not_to accept(nil, '', 'X' * 36, 'ABC 123', '#/*', 'Ümläüt', for: %i[mandate_id mid])
  end
